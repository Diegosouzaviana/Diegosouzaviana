...
import { OMNIDEF } from './oS_UpdateInformationCustomerEnglish_def.js';
import tmpl from './oS_UpdateInformationCustomerEnglish.html';
import tmpl_nds from './oS_UpdateInformationCustomerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_UpdateInformationCustomerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
