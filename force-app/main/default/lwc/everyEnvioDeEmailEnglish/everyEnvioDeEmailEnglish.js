...
import { OMNIDEF } from './everyEnvioDeEmailEnglish_def.js';
import tmpl from './everyEnvioDeEmailEnglish.html';
import tmpl_nds from './everyEnvioDeEmailEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class everyEnvioDeEmailEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
