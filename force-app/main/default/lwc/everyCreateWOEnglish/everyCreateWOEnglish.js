...
import { OMNIDEF } from './everyCreateWOEnglish_def.js';
import tmpl from './everyCreateWOEnglish.html';
import tmpl_nds from './everyCreateWOEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class everyCreateWOEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
