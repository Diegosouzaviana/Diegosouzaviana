...
import { OMNIDEF } from './lXDOS_ChangeAddressPortugueseBrazil_def.js';
import tmpl from './lXDOS_ChangeAddressPortugueseBrazil.html';
import tmpl_nds from './lXDOS_ChangeAddressPortugueseBrazil_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lXDOS_ChangeAddressPortugueseBrazil extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
