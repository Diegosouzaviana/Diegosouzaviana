...
import { OMNIDEF } from './everyCreateServiceOrderEnglish_def.js';
import tmpl from './everyCreateServiceOrderEnglish.html';
import tmpl_nds from './everyCreateServiceOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class everyCreateServiceOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
